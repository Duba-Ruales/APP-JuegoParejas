    ...
    <div class="prueba fondo2 ">
        <div class="col-12 ">
            ...
            <p>
                ...
                <span class="h5">Tiempo: </span><span id="minutos"></span> : <span id="segundos"></span>
            </p>
        </div>
    </div>
...
export default {
    ...
    data(){
        return{
            ...
            aciertos: 0,
            memorama:[],
            NOMBRE_IMAGEN_OCULTA: "https://coleenriquealonso.files.wordpress.com/2014/12/signo-de-interrogacion.gif",
    ...
    methods: {
        ...
        pause(){
            swal({
                icon: "https://pauseonline.s3.eu-west-2.amazonaws.com/wp-content/uploads/2019/11/01131317/Pause-Logo.png",
